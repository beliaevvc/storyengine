    ...
    <div className="space-y-1">
      ...
      {definition.type === 'text' && (
        <textarea
          ...
          placeholder={config.default as string ?? 'Введите текст...'}
          rows={3}
          className="w-full px-3 py-2 text-sm bg-overlay border border-border rounded-md resize-none focus:outline-none focus:ring-2 focus:ring-accent-primary focus:border-transparent placeholder:text-fg-muted"
        />
      )}
