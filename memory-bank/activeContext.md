...
|--------|----------|-------|
| MODAL-001 | Профиль сущности в модальном окне | `archive/archive-MODAL-001.md` ✅ |
| NAV-002 | Автопереключение в редактор при клике на документ | `archive/archive-NAV-002.md` ✅ |
| FLOW-001 | Рефакторинг FlowCanvas — объединение вкладок | `archive/archive-FLOW-001.md` ✅ |
| FLOW-002 | Интерактивная работа со связями (drag & drop, меню) | `archive/archive-FLOW-002.md` ✅ |
| NAV-001 | Навигация и сохранение состояния workspace | `archive/archive-NAV-001.md` ✅ |
| UI-002 | Улучшения UX интерфейса (фильтры, вкладки, проекты, блоки) | `archive/archive-UI-002.md` ✅ |
